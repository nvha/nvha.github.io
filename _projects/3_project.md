...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/tdma-nc/Result_Fairness_Probability_5cases-001-001.jpg" title="Per-node Daily Average Power 
        Consumption" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
