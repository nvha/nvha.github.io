...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/sdn_fedrp/Fig-Topology-001-001.jpg" title="Mininet Multi-Path Evaluation Topology" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
